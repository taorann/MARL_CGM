...
# Optional: execution engine that enables official tool-calling without
# modifying vendored rLLM code.
try:  # pragma: no cover
    from .agent import GraphPlannerToolExecutionEngine
...
__all__ = [
    ...
    "GraphPlannerRLLMEnv",
    "GraphPlannerToolExecutionEngine",
    "CGMRLLMAgent",
    "CGMRLLMEnv",
    "GRAPH_PLANNER_DATASET_NAME",
    "GRAPH_PLANNER_CGM_DATASET_NAME",
